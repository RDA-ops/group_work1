...
if 1000 <= num <= 9999:
    ...
    if sum_first_two == sum_last_two:
        print(f"а) Сумма первых двух цифр ({sum_first_two}) равна сумме"
              "последних двух ({sum_last_two})")
    else:
        print(f"а) Сумма первых двух цифр ({sum_first_two}) не равна"
              "сумме последних двух ({sum_last_two})")
